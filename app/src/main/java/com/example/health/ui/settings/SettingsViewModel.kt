...
class SettingsViewModel @Inject constructor(
    ...
    val disclaimerAccepted = userPrefsRepo.disclaimerAccepted
        .stateIn(viewModelScope, SharingStarted.WhileSubscribed(5000), false)
    val userName = userPrefsRepo.userName
        .stateIn(viewModelScope, SharingStarted.WhileSubscribed(5000), "")
    val userAge = userPrefsRepo.userAge
        .stateIn(viewModelScope, SharingStarted.WhileSubscribed(5000), "")
    val userBloodGroup = userPrefsRepo.userBloodGroup
        .stateIn(viewModelScope, SharingStarted.WhileSubscribed(5000), "")
    val userConditions = userPrefsRepo.userConditions
        .stateIn(viewModelScope, SharingStarted.WhileSubscribed(5000), "")
    val userHeight = userPrefsRepo.userHeight
        .stateIn(viewModelScope, SharingStarted.WhileSubscribed(5000), "")
    val userWeight = userPrefsRepo.userWeight
        .stateIn(viewModelScope, SharingStarted.WhileSubscribed(5000), "")
    ...
    fun setUserName(v: String) = viewModelScope.launch { userPrefsRepo.setUserName(v) }
    fun setUserAge(v: String) = viewModelScope.launch { userPrefsRepo.setUserAge(v) }
    fun setUserBloodGroup(v: String) = viewModelScope.launch { userPrefsRepo.setUserBloodGroup(v) }
    fun setUserConditions(v: String) = viewModelScope.launch { userPrefsRepo.setUserConditions(v) }
    fun setUserHeight(v: String) = viewModelScope.launch { userPrefsRepo.setUserHeight(v) }
    fun setUserWeight(v: String) = viewModelScope.launch { userPrefsRepo.setUserWeight(v) }
}
