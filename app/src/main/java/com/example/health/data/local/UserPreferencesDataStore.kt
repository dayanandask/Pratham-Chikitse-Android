...
class UserPreferencesDataStore @Inject constructor(
    ...
    val userName: Flow<String> = safeFlow(
        context.dataStore.data.map { it[Keys.USER_NAME] ?: "" }, ""
    )
    val userAge: Flow<String> = safeFlow(
        context.dataStore.data.map { it[Keys.USER_AGE] ?: "" }, ""
    )
    val userBloodGroup: Flow<String> = safeFlow(
        context.dataStore.data.map { it[Keys.USER_BLOOD_GROUP] ?: "" }, ""
    )
    val userConditions: Flow<String> = safeFlow(
        context.dataStore.data.map { it[Keys.USER_CONDITIONS] ?: "" }, ""
    )
    val userHeight: Flow<String> = safeFlow(
        context.dataStore.data.map { it[Keys.USER_HEIGHT] ?: "" }, ""
    )
    val userWeight: Flow<String> = safeFlow(
        context.dataStore.data.map { it[Keys.USER_WEIGHT] ?: "" }, ""
    )
    ...
    suspend fun setUserName(v: String) { context.dataStore.edit { it[Keys.USER_NAME] = v } }
    suspend fun setUserAge(v: String) { context.dataStore.edit { it[Keys.USER_AGE] = v } }
    suspend fun setUserBloodGroup(v: String) { context.dataStore.edit { it[Keys.USER_BLOOD_GROUP] = v } }
    suspend fun setUserConditions(v: String) { context.dataStore.edit { it[Keys.USER_CONDITIONS] = v } }
    suspend fun setUserHeight(v: String) { context.dataStore.edit { it[Keys.USER_HEIGHT] = v } }
    suspend fun setUserWeight(v: String) { context.dataStore.edit { it[Keys.USER_WEIGHT] = v } }
}
