...
class UserPreferencesRepository @Inject constructor(
    ...
    val userAge: Flow<String> = dataStore.userAge
    val userBloodGroup: Flow<String> = dataStore.userBloodGroup
    val userConditions: Flow<String> = dataStore.userConditions
    val userHeight: Flow<String> = dataStore.userHeight
    val userWeight: Flow<String> = dataStore.userWeight
    ...
    suspend fun setUserName(v: String) = dataStore.setUserName(v)
    suspend fun setUserAge(v: String) = dataStore.setUserAge(v)
    suspend fun setUserBloodGroup(v: String) = dataStore.setUserBloodGroup(v)
    suspend fun setUserConditions(v: String) = dataStore.setUserConditions(v)
    suspend fun setUserHeight(v: String) = dataStore.setUserHeight(v)
    suspend fun setUserWeight(v: String) = dataStore.setUserWeight(v)
}
